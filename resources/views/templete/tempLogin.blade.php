<div class="container ">
    <div class="d-flex justify-content-center LoginCenter">
        <div class="col-8  border border-dark shadow ">
            <div class="row">
                <div class="col text-center rounded border border-dark pb-2 pt-2 {{ ($title === 'Register') ? 'sung' : 'sing' }} ">
                    <a href="{{ route('register') }}">Sign In</a>
                </div>
                <div class="col text-center rounded border border-dark pb-2 pt-2 {{ ($title === 'login') ? 'sung' : 'sing' }}">
